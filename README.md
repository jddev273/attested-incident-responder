...
Deck: [AIR_BUIDL_CTC_2026.pdf](https://jddev273.github.io/attested-incident-responder/AIR_BUIDL_CTC_2026.pdf)
...
| `scripts/live_model_smoke.py` | Optional live AI check; skips unless `AIR_MODEL_API_KEY` is set |
